    ...
    { 
     ...
     function addComm(sid){
			...
			$.ajax({
	   			  ...
	   			  url: "crm/comm/", //{"action":"searchStudent","doesBill":true}
	    ...
	    function  printFrame(frameId, payAmount,purpose,startDate,endDate,payDate,payer,receiver)
	    {
			...
			html += '<p style="color:red;position:absolute;left:150px;top:90px;">'+purpose+'('+startDate+'~'+endDate+')</p>';
