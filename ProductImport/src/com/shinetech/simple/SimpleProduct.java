...
//	public  String size;
	 ...
	 * imgRelated:图片相关的变量
	 */ 
	public ImageRelated imgRelated = new ImageRelated() ;
	/**
...
//	private String attrss = "wedding_back_details,wedding_body_shape,wedding_embellishment,wedding_fabric,wedding_hemline,wedding_neckline,wedding_season,wedding_silhouette,wedding_sleeve_length,wedding_sleeve_style,wedding_special_occasion_dresses,wedding_style,wedding_train,wedding_venues,wedding_waistline,wedding_wedding_dresses,no_wedding_back_details,no_wedding_body_shape,no_wedding_embellishment,no_wedding_fabric,no_wedding_hemline,no_wedding_neckline,no_wedding_season,no_wedding_silhouette,no_wedding_sleeve_length,no_wedding_sleeve_style,no_wedding_special_occasion_dresses,no_wedding_style,no_wedding_train,no_wedding_venues,no_wedding_waistline,no_wedding_wedding_dresses";
	...
	public void genericSimpleProduct(){
		...
		for(int i = 0; i< rows;i++){
			...
			if(i == 0){
				proStr = proStr +","+itemcode+","+sortScore+","+petticoat+","+shownColor;
			}else{
				proStr = proStr+","+",";
			}
			op.addContentToEndOfFile2(Const.OUT_IMPORT_SIMPLE_CSV, proStr);
...
//			System.out.println(sb.toString());
	...
	private void genericHeader(){
		String header = "sku,_store,_attribute_set,_type,_product_websites,country_of_manufacture,created_at,custom_design,custom_design_from," +
				"custom_design_to,custom_layout_update,description,discount,enable_googlecheckout,gallery,gift_message_available,has_options," +
				"is_imported,media_gallery,meta_description,meta_keyword,meta_title,minimal_price,msrp,msrp_display_actual_price_type,msrp_enabled," +
				"name,news_from_date,news_to_date,options_container,page_layout,price,required_options,short_description,special_from_date," +
				"special_price,special_to_date,status,tax_class_id,updated_at,url_key,url_path,visibility,weight,qty,min_qty,use_config_min_qty," +
				"is_qty_decimal,backorders,use_config_backorders,min_sale_qty,use_config_min_sale_qty,max_sale_qty,use_config_max_sale_qty,is_in_stock," +
				"notify_stock_qty,use_config_notify_stock_qty,manage_stock,use_config_manage_stock,stock_status_changed_auto,use_config_qty_increments," +
				"qty_increments,use_config_enable_qty_inc,enable_qty_increments,_links_related_sku,_links_related_position,_links_crosssell_sku," +
				"_links_crosssell_position,_links_upsell_sku,_links_upsell_position,_associated_sku,_associated_default_qty,_associated_position," +
				"_tier_price_website,_tier_price_customer_group,_tier_price_qty,_tier_price_price,_category,_custom_option_store,_custom_option_type," +
				"_custom_option_title,_custom_option_is_required,_custom_option_price,_custom_option_sku,_custom_option_max_characters," +
				"_custom_option_sort_order,_custom_option_row_title,_custom_option_row_price,_custom_option_row_sku," +
				"_custom_option_row_sort,image,image_label,small_image,small_image_label,thumbnail,thumbnail_label,_media_attribute_id,_media_image,_media_lable," +
				"_media_position,_media_is_disabled,"+attrs+",itemcode,sort_score,petticoat,showncolor";
		op.clearAndWrite(Const.OUT_IMPORT_SIMPLE_CSV, header);
//		System.out.println(header);
	 ...
	 * int
	 */
	private  int getRows(List<CustomOption> customOptionList,ImageRelated imgRelated,Map<String,List<String>> attrMap){
		int rows = 0;
