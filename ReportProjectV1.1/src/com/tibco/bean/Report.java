  ...
  /**主诉*/ 
	...
	public String toString() {
		return "Report [reportId=" + reportId + ", patientName=" + patientName
				...
				+ isMenopause + ", department=" + department
				+ ", isLeucorrhea=" + isLeucorrhea + ", isBleed=" + isBleed
				+ ", unregularBleed=" + unregularBleed + ", otherComplaints="
				+ otherComplaints + ", isSmooth=" + isSmooth
